...
**3.**数量积的几何意义：$\vert\vec{b}\vert \cos \theta$叫做向量$\vec{a}$在$\vec{b}$方向上($\vec{b}$在$\vec{a}$方向上)的**投影**(结果是一个数)。

<img src="高中数学_img/image-20210328090021744.png" alt="image-20210328090021744" style="zoom:67%;" />

$\vert\vec{b}\vert \cos \theta   = \frac{\vec{a} \cdot  \vec{b} }{\vert\vec{a}\vert} $
